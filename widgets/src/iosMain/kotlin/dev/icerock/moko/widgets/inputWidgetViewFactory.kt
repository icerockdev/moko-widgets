...
class InputWidgetView : UIView(frame = CGRectZero.readValue()), UITextFieldDelegateProtocol,
    ...
    init {
        ...
        textField = UITextField(frame = CGRectZero.readValue()).apply {
            ...
            topAnchor.constraintEqualToAnchor(container.topAnchor, constant = 14.0).active = true
        ...
        errorLabel = UILabel(frame = CGRectZero.readValue()).apply {
            ...
            topAnchor.constraintEqualToAnchor(textField.bottomAnchor, constant = 4.0).active = true
            leadingAnchor.constraintEqualToAnchor(container.leadingAnchor).active = true
            trailingAnchor.constraintEqualToAnchor(container.trailingAnchor).active = true
