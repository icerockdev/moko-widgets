Pod::Spec.new do |spec|
    spec.name                     = 'moko-widgets-datepicker'
    spec.version                  = '0.1.0'
    ...
    spec.module_name              = "mokoWidgetsDatePicker"

    spec.source_files             = "widgets-datepicker/src/iosMain/swift/**/*.{h,m,swift}"
    spec.resources                = "widgets-datepicker/src/iosMain/bundle/**/*"
